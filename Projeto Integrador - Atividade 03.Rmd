...
``` 
*Mostre com um comando e usando um grafico a distribuição das idades dessa amostra de alunos que fizeram ENADE em 2014. Comente o resultado.*
...
*Monte uma tabela exibindo as porcentagens e os valores absolutos das proporções de alunos por cor/raça. O que descobrimos sobre isso?*
...
*Apresente a proporção de alunos casados e solteiros. Atenção, queremos apenas casados e solteiros. Exclua de sua analise os alunos que tiverem outro tipo de estado civil.*
